...
- y ~ normal(0,exp(x/2))の部分
  - 正規分布の再生性より、平均$\mu$、分散$\sigma^2$の正規分布に従う確率変数$X$を定数$c$倍した確率変数$cX$は、平均$c \mu$、分散$c^2 \sigma^2$の正規分布に従います。つまり、$cX \sim N(c \mu,c^2 \sigma^2)$となります。これより、$y \sim N(0, \sigma_{\eta}^2/(1-\phi^2)$
